...
Implement a function to compute the closest point in a collection of points according to an
L1 distance. For a reminder of L1 distance, check out: https://iq.opengenus.org/manhattan-distance/
...
def compute_closest_point(query, points):
    ...
    min_distance = np.argmin(manhattan)
    return min_distance


compute_closest_point(QUERY, POINTS)
